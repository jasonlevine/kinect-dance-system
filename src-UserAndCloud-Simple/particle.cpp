...
//------------------------------------------------------------
void particle::update(int tailLength){
	vel = vel + frc;
	pos = pos + vel;
...
//------------------------------------------------------------
void particle::bounceOffWalls(float minx, float miny, float maxx, float maxy){
...
//------------------------------------------------------------
void particle::wrapAround(float minx, float miny, float maxx, float maxy){
